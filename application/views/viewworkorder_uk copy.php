...
<td height="119">
    <form id="formnew1" action="<?php echo site_url('workflow_uk/unassignweldbay') ?>" method="POST">
        ...
        <?php $row = $this->work_model->get_by_slotnumber($snum); ?> 
             ...
             <input type="submit" <?php if ($et9=="WELD BAY"){echo 'disabled="" '; }?>  id='<?php echo $set9?>'   name="weld bay" style="white-space:normal;font-size:15px;color:black;border:none;width:130px;height:150px;text-emphasis-color: black;background-color:#2E7091;background-color: <?php echo $set9; ?>;" value="<?php echo $et9 ?>" ></input>
