...
//echo $workorderid;
 ...
 $results = $this->work_model_uk->slotsfilled();
  $slotarray=array();
  $eqid=array();
 ...
 foreach ($results as $row): 
           // foreach ($result as $row):
                    ...
                    if( $slotarray[$i]=='1') // or if(call())
                 {
                  ...
                  {
                      $set9='greenyellow';
                       $et9='WELD BAY TECHNICAL ID:  '.$eqid[$i];
                  }
...
<div  style="background-color: lightsalmon;" id="container" style="width:100%;">
...
<tr>
<td><a
<button  href="<?php echo site_url('workflow_uk/assignweldbay')?>" type="button"  class="btn btn-india" style="height:50px;width:190px">Onrepair workorder</button></a>
</td>
</tr>
<tr>
<td><a
<button  href="<?php echo site_url('workflow_uk/reassignwkorder')?>" type="button"  class="btn btn-india" style="height:50px;width:190px">Repaired workorder</button></a>
</td>
</tr>
<tr>
<td><a
...
<tr>
<td><a
<button href="<?php echo site_url('workflow/transfer')?>" type="button" class="btn btn-india " style="height:50px;width:190px"  >Change Between Slots</button></a>
</td>
</tr>
<tr>
<td>
...
<table style="width: 40%;position: absolute;left:20%;top:30%;background-color:white;text-emphasis-color: black;">
<tr>
<td height="119">
 ...
 <input style="width:200px;" type="hidden" name="coid" width ="70%"id="co651" value="<?php echo $row->containersize ?>" />
   <input style="width:200px;" type="hidden" name="mid" width ="70%"id="co651" value="<?php echo $row->manufacturer ?>" />          
             <input type="submit" <?php if ($et1=="SLOT 1"){echo 'disabled="" '; }?>  id='<?php echo $set1?>'   name="slot1" style="white-space:normal;font-size:15px;color:black;border:none;width:130px;height:150px;text-emphasis-color: black;background-color:#2E7091;background-color: <?php echo $set1; ?>;" value="<?php echo $et1 ?>" ></input>
</form>
</td>
<td>
  ...
  <input  type="submit" <?php if ($et2=="SLOT 2"){echo 'disabled="" '; }?>  name="slot2" id="<?php echo $set2?>" style="white-space:normal;font-size:15px;color:black;border:none;width:130px;height:150px;border-width: 2px;text-emphasis-color: black;background-color:#2E7091;background-color: <?php echo $set2; ?>;"  value="<?php echo $et2?>"></input>
</form>
</td>
<td>
 ...
 <input style="width:200px;" type="hidden" name="coid3" width ="70%"id="c78751" value="<?php echo $row3->containersize ?>" />
  ...
  <input type="submit" <?php if ($et3=="SLOT 3"){echo 'disabled="" '; }?>  name="slot3" id="<?php echo $set3?>" style="white-space:normal;font-size:15px;color:black;border:none;width:130px;height:150px;text-emphasis-color: black;background-color:#2E7091;background-color: <?php echo $set3; ?>;"  value="<?php echo $et3?>"></input>
</form>
</td>
<td>
...
<input type="submit"  name="slot4" <?php if ($et4=="SLOT 4"){echo 'disabled="" '; }?> id="<?php echo $set4?>" style="white-space:normal;font-size:15px;color:black;border:none;width:130px;height:150px;text-emphasis-color: black;background-color:#2E7091;background-color: <?php echo $set4; ?>;" value="<?php echo $et4?>"></input>
</form></td>
</tr>
<tr>
<td height="200">
...
<input type="submit" <?php if ($et5=="SLOT 5"){echo 'disabled="" '; }?>  name="<?php echo site_url('workflow/storewkflow')?>" id="<?php echo $set5?>" style="white-space:normal;font-size:15px;color:black;text-emphasis-color: black;border:none;width:130px;height:150px;background-color:#2E7091;background-color: <?php echo $set5; ?>;" value="<?php echo $et5?>"</input>
</form></td>
<td>
...
<input type="submit" <?php if ($et6=="SLOT 6"){echo 'disabled="" '; }?> name="slot6" id="<?php echo $set6?>" style="white-space:normal;font-size:15px;color:black;border:none;width:130px;height:150px;background-color:#2E7091;background-color: <?php echo $set6; ?>;" value="<?php echo $et6?>"></input>
</form>
</td>
...
<input type="submit" <?php if ($et7=="SLOT 7"){echo 'disabled="" '; }?>  name="slot7" id="<?php echo $set7?>" style="white-space:normal;font-size:15px;color:black;border:none;width:130px;height:150px;background-color:#2E7091;background-color: <?php echo $set7; ?>;" value="<?php echo $et7?>"></input>
</form>
</td>
<td>
...
<input type="submit" <?php if ($et8=="SLOT 8"){echo 'disabled="" '; }?> name="slot8" id="<?php echo $set8?>" style="white-space:normal;font-size:15px;color:black;border:none;width:130px;height:150px;background-color:#2E7091;background-color: <?php echo $set8; ?>;" value="<?php echo $et8?>"></input>
</form>
</td>
</tr>
</table>
...
<table style="width: 30%;position: absolute;left:70%;top:40%;background-color:white;text-emphasis-color: black;">
<tr>
<td height="119">
    <form id="formnew1" action="<?php echo site_url('workflow_uk/unassignweldbay') ?>" method="POST">
         <?php $snum='9' ?>
        <?php $row = $this->work_model->get_by_slotnumber($snum); ?> 
             <input type="hidden" style="position:absolute;top:79%;width:71px;height:25px;" name="wokid9" value="<?php echo $row->workorderid ?>" id="fnew1" />    
             ...
             <input type="button" href="#myModal" <?php if ($et9=="WELD BAY"){echo 'disabled="" '; }?>  data-toggle="modal" id='<?php echo $set9?>' 
                    name="weld bay" style=" white-space:normal;font-size:15px;color:black;border:none;width:130px;height:150px;text-emphasis-color: black;background-color:#2E7091;background-color: <?php echo $set9; ?>;" value="<?php echo $et9 ?>" ></input>
