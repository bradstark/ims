...
<body>
 ...
 <form id="tab" action="<?php echo site_url('workflow_uk/assignweldbaywkflow') ?>" method="POST">
...
<div class="well">
    <table class="table table-hoover">
        ...
        <tbody>
            <?php
            $isocontainer1 = $this->work_model_uk->get_allonrepair();
            $j = 0;
     ...
     <div>
         ...
         <input class="btn btn-danger"name="reassign" type="submit" id="delete" value="AssignWeldbay">    
                </div>
